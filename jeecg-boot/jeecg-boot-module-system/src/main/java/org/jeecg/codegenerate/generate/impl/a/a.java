package org.jeecg.codegenerate.generate.impl.a;
...
public class a {
    ...
    protected void a(String var1, File var2, Map<String, Object> var3, org.jeecg.codegenerate.generate.a.a var4) throws Exception {
        if (var2 == null) {
            throw new IllegalStateException("'templateRootDir' must be not null");
        } else {
            a.debug("-------------------load template from templateRootDir = '" + var2.getAbsolutePath() + "' outJavaRootDir:" + (new File(org.jeecg.codegenerate.config.AppConfig.i.replace(".", File.separator))).getAbsolutePath() + "' outWebappRootDir:" + (new File(org.jeecg.codegenerate.config.AppConfig.j.replace(".", File.separator))).getAbsolutePath());
            List var5 = org.jeecg.codegenerate.generate.util.a.a(var2);
    ...
    protected void a(String var1, File var2, Map<String, Object> var3, File var4, org.jeecg.codegenerate.generate.a.a var5) throws Exception {
        ...
        String var6 = org.jeecg.codegenerate.generate.util.a.a(var2, var4);
        ...
        try {
            ...
            if (var7.startsWith("java")) {
                var8 = var1 + File.separator + org.jeecg.codegenerate.config.AppConfig.i.replace(".", File.separator);
                var7 = var7.substring("java".length());
                var7 = var8 + var7;
                a.debug("-------java----outputFilepath--" + var7);
                this.a(var6, var7, var3, var5);
            } else if (var7.startsWith("webapp")) {
                var8 = var1 + File.separator + org.jeecg.codegenerate.config.AppConfig.j.replace(".", File.separator);
    ...
    protected void a(String var1, String var2, Map<String, Object> var3, org.jeecg.codegenerate.generate.a.a var4) throws Exception {
        if (var2.endsWith("i")) {
        ...
        File var6 = org.jeecg.codegenerate.generate.util.a.c(var2);
    ...
    protected Template a(String var1, org.jeecg.codegenerate.generate.a.a var2) throws IOException {
    ...
    protected static String a(Map<String, Object> var0, String var1, org.jeecg.codegenerate.generate.a.a var2) throws Exception {
        String var3 = var1;
        boolean var4 = true;
        int var8;
